...
router.get('/dogs', async (req, res) => {
    try {
        const [dogs] = await db.execute('SELECT d.name AS dog_name, d.size, u.username AS owner_username FROM Dogs AS d JOIN Users AS u ON Dogs.owner_id = Users.user_id');
        res.json(dogs);
    } catch (error) {
